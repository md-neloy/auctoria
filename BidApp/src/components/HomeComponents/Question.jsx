const Question = () => {
  return (
    <div>
        <div>
        <h2 className='font-bold text-center text-black text-5xl pt-10 pb-5'> Frequently Asked Questions</h2>
        </div>
     ...
     <div className="collapse collapse-plus bg-base-200">
        ...
        <div className="collapse-content">
          <p>Bidding is simple! Just place your bid and watch the excitement unfold!</p>
        </div>
      </div>
      <div className="collapse collapse-plus bg-base-200">
